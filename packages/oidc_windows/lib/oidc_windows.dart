...
class OidcWindows extends OidcPlatform {
  ...
  Future<OidcAuthorizeResponse?> getAuthorizationResponse(
    ...
    final listener = OidcLoopbackListener(
      ...
      successfulPageResponse: options.windows.successfulPageResponse,
      methodMismatchResponse: options.windows.methodMismatchResponse,
      notFoundResponse: options.windows.notFoundResponse,
    );
